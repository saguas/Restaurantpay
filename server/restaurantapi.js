...
ThirdPartyAPI = {
  authorize: function (transactionType, paymentData) {
...
RestaurantAPI.methods.authorize = new ValidatedMethod({
  name: "RestaurantAPI.methods.authorize",
  validate: new SimpleSchema({
    transactionType: { type: String },
    paymentData: { type: paymentDataSchema }
  }).validator(),
  run({ transactionType, paymentData }) {
    let results = ThirdPartyAPI.authorize(transactionType, paymentData);
    return results;
  }
});


RestaurantAPI.methods.capture = new ValidatedMethod({
  name: "RestaurantAPI.methods.capture",
  validate: new SimpleSchema({
...
RestaurantAPI.methods.refund = new ValidatedMethod({
  name: "RestaurantAPI.methods.refund",
  validate: new SimpleSchema({
...
RestaurantAPI.methods.refunds = new ValidatedMethod({
  name: "RestaurantAPI.methods.refunds",
  validate: new SimpleSchema({
    transactionId: { type: String }
  }).validator(),
  run(args) {
